    ...
    def loss(self, X, y=None):
        ...
        for i in range(1, self.num_layers):
          ...
          if self.normalization == "batchnorm":
            ...
            out_i, cache[f'ch{i}r'] = layernorm_forward(out_i, self.params[f'gamma{i}'], self.params[f'beta{i}'], self.bn_params[i-1])
        ...
        lx_dx, grads[f'W{self.num_layers}'], grads[f'b{self.num_layers}'] = affine_backward(g_softmax, cache[f'ch{self.num_layers}a'])
